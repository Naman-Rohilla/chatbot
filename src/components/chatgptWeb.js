...
export default function ChatgptWeb() {
  ...
  async function submitChat(e) {
    ...
    if (e.key == "Enter") {
      ...
      try {
        let finalstr = "Your name is Kush the most intelligent guy, If someone greets you you also greets him. Now,You can use this paragraph for refernce:";
        if (query.length < 300) {
  ...
  return (
    <>
      <div className="h-screen bg-gray-800 flex">
        ...
        <div className="flex flex-col h-screen items-center justify-between bg-gray-900 w-1/4">
        ...
        <div className="h-screen pb-40 overflow-y-scroll w-3/4 flex flex-col items-center justify-between">
          ...
          <div className="bg-gray-800 flex flex-col items-center w-4/6 absolute bottom-0 pt-2">
            <input
              placeholder="what you want to know?"
              className="text-white rounded-sm text-lg px-4 focus:outline focus:outline-gray-700 outline-none h-16 w-3/4 bg-gray-900 mb-6"
              value={query}
