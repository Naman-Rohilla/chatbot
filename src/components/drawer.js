...
function Drawer({ file, setNumPages, setPageNumber, numPages, pageNumber, left }) {
    ...
    <>
      <div className={`drawer ${isOpen ? "open" : ""} z-50`}>
        <Document
          ...
          //   onError={onError}
        >
          <Page width={400} height={600} pageNumber={pageNumber} />
        </Document>
        <div className="absolute bottom-0 left-5">
          <p className="text-gray-400 font-styleFont font-bold">
            {pageNumber} / {numPages}
          </p>
        </div>
        <div className="z-50 absolute bottom-0 right-3 font-bold text-2xl">
          <button
