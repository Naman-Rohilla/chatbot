...
export default function FooterMobile({ targetElement }) {
          ...
          <div className="flex space-x-5 p-4">
            ...
            <span className="flex flex-col text-white ">
              ...
              <Link
                ...
                className="pt-1 cursor-pointer"
              >
                JPMC Job Simulation forage
              </Link>
            </span>
          </div>
        </div>
        <div className="w-full px-4 flex flex-col justify-center items-center space-y-2">
          <div className="flex flex-col text-white space-y-2">
            <span>Name</span>
            <input
              value={name}
              onChange={nameChange}
              className="w-80 h-10 rounded-sm shadow-md text-gray-800 pl-2 outline-none"
              type="text"
            ></input>
          </div>
          <div className="flex flex-col text-white space-y-2">
          ...
          <div className="flex flex-col text-white space-y-2">
            ...
            <textarea
              ...
              className="w-80 h-28 rounded-sm shadow-md text-gray-800 pl-2 pt-2 outline-none"
              type="text"
            ></textarea>
          </div>
          {checksubmit ? (
            <button
              ...
              className="flex cursor-not-allowed flex-col text-gray-400 space-y-2 w-80 h-10 justify-center bg-gray-700 items-center"
            >
              <span>Submit</span>
            </button>
          ) : (
            <button
              onClick={handleSubmit}
              className="flex flex-col text-white space-y-2 w-80 h-10 justify-center bg-gray-900 items-center"
            >
              <span>Submit</span>
            </button>
          )}
        </div>
        <div className="flex justify-between mt-7 border-t border-dotted pt-7 px-2">
          <span className="flex mb-4 space-x-4 text-white">
          ...
          <div className="flex space-x-2 -mt-1 text-white">
