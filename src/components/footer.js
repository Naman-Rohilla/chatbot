...
export default function Footer() {
  return (
    <>
      <div className="z-20 bottom-0 bg-gray-800 border-t border-white shadow-sm h-96 flex justify-between">
        <div className="h-full flex flex-col justify-between w-1/3">
          ...
          <span className="flex pb-4 space-x-4 pl-10 text-white">
        ...
        <div className="w-2/5 flex flex-col justify-center items-end pr-14 space-y-2">
            <div className="flex flex-col text-white space-y-2 ml-10">
                <span>Name</span>
                <input className="w-96 h-10 rounded-sm shadow-md text-gray-800 pl-2 outline-none" type="text"></input>
            </div>
            <div className="flex flex-col text-white space-y-2 ml-10">
                <span>Email</span>
                <input className="w-96 h-10 rounded-sm shadow-md text-gray-800 pl-2 outline-none" type="text"></input>
            ...
            <div className="flex flex-col text-white space-y-2 ml-10">
                <span>Message</span>
                <textarea className="w-96 h-28 rounded-sm shadow-md text-gray-800 pl-2 pt-2 outline-none" type="text"></textarea>
            </div>
            <div className="flex flex-col text-white space-y-2 ml-10 w-96 h-10 justify-center bg-gray-900 items-center">
                <span>Submit</span>
